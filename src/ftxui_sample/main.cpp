...
// configuration step. It creates a namespace called `electronic_design_automation`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", electronic_design_automation::cmake::project_name, electronic_design_automation::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", electronic_design_automation::cmake::project_version);
      return EXIT_SUCCESS;
    }
