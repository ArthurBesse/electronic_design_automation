...
{
	template<size_t N> struct TwoOperandGateIO;

	template<> struct TwoOperandGateIO<1>
	{
	...
	template<size_t N> struct ArithmeticLogicUnitIO;

	template<> struct ArithmeticLogicUnitIO<1>
	{
		Passthrough *m_input_a = nullptr;
		Passthrough *m_input_b = nullptr;
		Passthrough *m_input_c = nullptr;
	...
	template<> struct ArithmeticLogicUnitIO<8>
	{
	...
	template<> struct TwoOperandGateIO<8>
	{
		Passthrough *m_input_a0 = nullptr;
		Passthrough *m_input_b0 = nullptr;
		Passthrough *m_input_a1 = nullptr;
